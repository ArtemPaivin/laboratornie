...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	HWND hWnd = CreateWindowW(szWindowClass, L"Laba13", WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONUP://событие клика левой кнопки мыши
		if (counter_for_hWnd < 7) {// если окон меньше 7 создаем новое, иначе выводим ошибку
	...
	case WM_CHAR://событие нажатия клавиши клавиатуры
		if (counter_for_hWnd > 0) {//если окон больше 0 закрываем окно, иначе выводим ошибку
